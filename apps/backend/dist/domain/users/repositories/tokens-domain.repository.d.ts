...
export interface TokensDomainRepository {
    ...
    readByTokenAndType(token: string, tokenType: ETokenType): Promise<Token | null>;
    readByTokenWithUserWhereUserIdIsUserIdIdAndTokenIsValid(token: string, userId: number): Promise<Token | null>;
